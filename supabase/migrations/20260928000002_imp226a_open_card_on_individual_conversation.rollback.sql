-- IMP-226 fase 1 rollback.
-- Restaura a definicao anterior, na qual somente mensagens recebidas com conversionSource
-- criavam oportunidade. Esta reversao e deliberada e deve ser usada apenas para rollback.
