-- Parser tie fix: preserve the production parser and disambiguate same-timestamp history.
    ...
    if v_de_mim
      ...
      values
        (ev.client_id, v_oportunidade_id, v_stage_lead, v_stage_atendim,
         'automatic', 'sistema', v_atividade_id, v_ocorrido + interval '1 microsecond');
