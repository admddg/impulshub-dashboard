-- IMP-205: publica movimentos de etapa do CRM no pipeline de conversoes existente.
--
...
create trigger opportunities_emit_stage_event
after insert or update of current_stage_id on crm.opportunities
