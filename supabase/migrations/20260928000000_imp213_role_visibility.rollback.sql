-- IMP-213 rollback to the post-IMP-229 production state.
begin;
set local lock_timeout = '5s';
alter policy meta_ads_daily_select_by_client_user on public.meta_ads_daily
  using (client_id in (select client_id from private.my_client_ids()));
alter policy google_ads_daily_select_by_client_user on public.google_ads_daily
  using (client_id in (select client_id from private.my_client_ids()));
alter policy google_ads_campaign_daily_select_by_client on public.google_ads_campaign_daily
  using (client_id in (select client_id from private.my_client_ids()));
alter policy google_ads_keywords_daily_select_by_client_user on public.google_ads_keywords_daily
  using (client_id in (select client_id from private.my_client_ids()));
alter policy events_normalized_select_by_client_user on public.events_normalized using (client_id in (select client_id from private.my_client_ids()));
...
grant all on table public.v_ads_spend_daily to anon, authenticated, service_role;
...
grant all on table public.v_channel_performance_daily to anon, authenticated, service_role;
...
grant all on table public.v_client_daily_pulse to anon, authenticated, service_role;
...
grant all on table public.v_client_performance_daily to anon, authenticated, service_role;
...
grant all on table public.v_client_performance_daily_v2 to anon, authenticated, service_role;
...
grant all on table public.v_crm_events_daily_v2 to anon, authenticated, service_role;
...
grant all on table public.v_crm_events_enriched to anon, authenticated, service_role;
...
grant all on table public.v_crm_events_feed_v2 to anon, authenticated, service_role;
...
grant all on table public.v_crm_funnel_daily to anon, authenticated, service_role;
...
grant all on table public.v_crm_opportunities to anon, authenticated, service_role;
...
grant all on table public.v_crm_opportunities_v2 to anon, authenticated, service_role;
...
grant all on table public.v_crm_sales_daily_v2 to anon, authenticated, service_role;
...
grant all on table public.v_crm_sales_v2 to anon, authenticated, service_role;
...
grant all on table public.v_google_ads_keywords_daily to anon, authenticated, service_role;
...
grant all on table public.v_google_ads_v2 to anon, authenticated, service_role;
...
grant all on table public.v_google_campaign_daily to anon, authenticated, service_role;
...
grant all on table public.v_google_campaign_performance to anon, authenticated, service_role;
...
grant all on table public.v_google_keywords_v2 to anon, authenticated, service_role;
...
grant all on table public.v_meta_account_daily to anon, authenticated, service_role;
...
grant all on table public.v_meta_ads_v2 to anon, authenticated, service_role;
...
grant all on table public.v_meta_campaign_daily to anon, authenticated, service_role;
...
grant all on table public.v_meta_campaign_performance to anon, authenticated, service_role;
...
grant all on table public.v_meta_creative_daily to anon, authenticated, service_role;
...
grant all on table public.v_meta_creative_performance to anon, authenticated, service_role;
...
grant all on table public.v_crm_card_history_v1 to anon, authenticated, service_role;
...
revoke all on table public.external_meta_ads_raw, public.external_ga4_raw, public.external_hotmart_raw, public.stevo_events_raw from public, anon, authenticated, service_role;
grant all on table public.external_meta_ads_raw, public.external_ga4_raw, public.external_hotmart_raw, public.stevo_events_raw to service_role;
grant all on table public.stevo_events_raw to anon, authenticated;
...
drop function private.can_view_client_financials(uuid);
drop function private.financial_client_ids();

do $rollback_gate$
declare missing integer;
begin
  if exists (select 1 from pg_proc p join pg_namespace n on n.oid=p.pronamespace where n.nspname='private' and p.proname in ('financial_client_ids','can_view_client_financials')) then raise exception 'IMP213_ROLLBACK: helpers novos ainda existem'; end if;
  if exists (select 1 from pg_policies where schemaname='public' and tablename in ('meta_ads_daily','google_ads_daily','google_ads_campaign_daily','google_ads_keywords_daily','events_normalized') and cmd='SELECT' and qual not ilike '%my_client_ids%') then raise exception 'IMP213_ROLLBACK: policy não voltou a my_client_ids'; end if;
  select count(*) into missing from (values ('v_ads_spend_daily'), ('v_channel_performance_daily'), ('v_client_daily_pulse'), ('v_client_performance_daily'), ('v_client_performance_daily_v2'), ('v_crm_events_daily_v2'), ('v_crm_events_enriched'), ('v_crm_events_feed_v2'), ('v_crm_funnel_daily'), ('v_crm_opportunities'), ('v_crm_opportunities_v2'), ('v_crm_sales_daily_v2'), ('v_crm_sales_v2'), ('v_google_ads_keywords_daily'), ('v_google_ads_v2'), ('v_google_campaign_daily'), ('v_google_campaign_performance'), ('v_google_keywords_v2'), ('v_meta_account_daily'), ('v_meta_ads_v2'), ('v_meta_campaign_daily'), ('v_meta_campaign_performance'), ('v_meta_creative_daily'), ('v_meta_creative_performance'), ('v_crm_card_history_v1')) required(view_name) where not exists (select 1 from pg_class c join pg_namespace n on n.oid=c.relnamespace where n.nspname='public' and c.relname=required.view_name and c.reloptions @> ARRAY['security_invoker=true']);
  if missing <> 0 then raise exception 'IMP213_ROLLBACK: % views não restauradas', missing; end if;
end;
$rollback_gate$;
commit;
